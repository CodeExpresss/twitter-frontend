...
class LayoutIndex extends Component {
    render() {
        ...
        if(bool) {
            return (
                <Redirect to={RouterStore.website.home} />
            );
        }
        ...
        return (
            <div className="component-layout__content">
                <div className="layout-index">
                    <div className="layout-index__left-bar">
                        <div className="layout-index__left-bar__wrap">
                            <div className='layout-index__left-bar__item'>
                                <svg viewBox="0 0 24 24"
                                     className="layout-index__left-bar__item__svg">
                                    <g>
                                        <path
